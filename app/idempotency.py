"""Stable fingerprints for side effects. Hashing, used for exactly-once execution."""
import hashlib
import json
...
def _normalise(value):
    """Make equal things look equal: 12.0 and 12 are the same id."""
...
def notification_dedupe_key(roll_no: str, message: str, day: date) -> str:
    """The same message to the same researcher on the same day is one notification."""
